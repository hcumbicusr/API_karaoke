...
INSERT INTO `music_business` (`id_music`,`id_musicgenre`,`id_typemusic`,`name`,`artist`,`album`,`description`,`year_album`,`ruta`,`likes`,`date_register`,`stat`) VALUES 
 (1,1,1,'Canción n 1','Art 1','Alb 1',NULL,'1990','',3,'2015-08-20 14:53:35',2),
 (2,1,1,'Canción n 2','Art 1','Alb 1',NULL,'1990','',2,'2015-08-20 14:53:35',2),
 (3,1,1,'Canción n 3','Art 1','Alb 1',NULL,'1990','',8,'2015-08-20 14:53:35',2),
 (4,2,1,'Canción n 4','Art 2','Alb 2',NULL,'2005','',10,'2015-08-20 14:53:35',2),
 (5,2,1,'Canción n 5','Art 3','Alb 3',NULL,'2006','',19,'2015-08-20 14:53:35',2),
 (6,3,1,'Canción n 6','Art 4','Alb 4',NULL,'2015','',40,'2015-08-20 14:53:35',2),
 (8,2,1,'Música de prueba','Art 4','','','1998','D:musica',0,'2015-08-23 16:51:27',2),
 ...
 (19,3,1,'cancion de prueba','art de prueba','alb prueba','aklsdflka ejlfaselfkajsldkfja lek','','http://localhost/AdminKaraoke/agregar_musica.php',0,'2015-09-07 23:54:10',2),
 (20,3,1,'name music test','art','alb','desc','2005','D:/HENRY/Musica/Lucho/MUSICA',0,'2015-09-07 23:56:22',2);
...
INSERT INTO `orders` (`id_order`,`id_table`,`id_music`,`date_order`,`date_attention`,`stat`) VALUES 
 (72,4,2,'2015-09-07 18:32:29','0000-00-00 00:00:00',0),
 (73,4,6,'2015-09-07 18:33:01','0000-00-00 00:00:00',0),
 (74,7,3,'2015-09-27 00:06:38','0000-00-00 00:00:00',0),
 (75,7,2,'2015-09-27 00:07:03','0000-00-00 00:00:00',0),
 (76,5,9,'2015-09-27 00:07:39','0000-00-00 00:00:00',0),
 (77,5,1,'2015-09-27 00:08:01','0000-00-00 00:00:00',0),
 (78,3,1,'2015-09-27 14:14:19','0000-00-00 00:00:00',0),
 (79,2,4,'2015-09-27 14:15:57','0000-00-00 00:00:00',0),
 (80,9,6,'2015-09-27 14:33:58','0000-00-00 00:00:00',0),
 (81,9,5,'2015-09-27 14:34:24','0000-00-00 00:00:00',0),
 (82,10,10,'2015-09-27 14:34:48','0000-00-00 00:00:00',0),
 (83,10,15,'2015-09-27 14:36:38','0000-00-00 00:00:00',0),
 (84,14,16,'2015-09-27 15:03:52','0000-00-00 00:00:00',0),
 (85,16,19,'2015-09-27 15:14:26','0000-00-00 00:00:00',0);
...
INSERT INTO `table_business` (`id_table`,`number`,`token`,`date_register`,`stat`) VALUES 
 (1,'1','1M71','2015-08-20 14:50:30',2),
 (2,'2','2M98','2015-08-20 14:50:30',2),
 (3,'3','3M16','2015-08-20 14:50:30',2),
 (4,'4','4M45','2015-08-20 14:50:30',2),
 (5,'5','5M65','2015-08-20 14:50:30',2),
 (6,'6','6M75','2015-08-20 14:50:30',2),
 (7,'7','7M79','2015-08-20 14:50:30',2),
 (8,'8','8M25','2015-08-20 14:50:30',2),
 (9,'9','9M44','2015-08-20 14:50:30',2),
 (10,'10','10M61','2015-08-20 14:50:30',2),
 (11,'11','11M10','2015-08-25 22:04:38',2),
 (12,'12','12M09','2015-08-25 22:35:02',2),
 (13,'13','13M04','2015-09-07 20:10:38',2),
 (14,'14','14M83','2015-09-07 23:01:25',2),
 (15,'15','15M41','2015-09-07 23:01:26',2),
 (16,'16','16M60','2015-09-07 23:19:01',2),
 (17,'17','17M13','2015-09-07 23:19:01',2),
 (18,'18','18M13','2015-09-07 23:20:53',2),
 (19,'19','19M00','2015-09-07 23:20:53',2);
...
--
-- Definition of procedure `sp_cambiar_estado_pedido`
--
...
update orders set stat = estado_i where id_order = id_pedido_i;
...
SELECT id_musicgenre as id, name as nombre FROM music_genre m;
...
SELECT m.*,g.name as genre, t.name as type_music, st.name as stat_desc
FROM music_business m
inner join music_genre g on m.id_musicgenre = g.id_musicgenre
inner join type_music t on m.id_typemusic = t.id_typemusic
inner join states st on m.stat = st.id_state
...
--
-- Definition of procedure `sp_listar_generos`
--
...
/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listar_generos`()
BEGIN
...
--
-- Definition of procedure `sp_listar_mis_pedidos`
--

DROP PROCEDURE IF EXISTS `sp_listar_mis_pedidos`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listar_mis_pedidos`(in mesa int)
BEGIN
...
--
-- Definition of procedure `sp_listar_pedidos_sin_atender`
--

DROP PROCEDURE IF EXISTS `sp_listar_pedidos_sin_atender`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listar_pedidos_sin_atender`()
BEGIN

select o.*,st.name as stat_desc, t.number, m.name as song, 
m.artist, m.album, m.description,
m.year_album, m.likes, g.name as genre,
m.ruta, DATE_FORMAT(o.date_order,'%d/%m/%Y %H:%i:%s') as date_order_desc 
from orders o
inner join table_business t on o.id_table = t.id_table
inner join music_business m on o.id_music = m.id_music
left join music_genre g on m.id_musicgenre = g.id_musicgenre
...
--
-- Definition of procedure `sp_login_mesa_token`
--

DROP PROCEDURE IF EXISTS `sp_login_mesa_token`;

DELIMITER $$

/*!50003 SET @TEMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ENGINE_SUBSTITUTION' */ $$
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_login_mesa_token`(
IN token_i varchar(6)
)
BEGIN

select * from table_business where token = token_i and stat = 2;
...
set @val = (select count(*) from table_business where number = mesa);

if (@val = 0) then -- cuando es una mesa nueva
...
else --  cuando ya está en la bd
  update table_business set stat = 2, token = token_i where number = mesa;
  commit;
  set salida = concat('OK',',','Mesa agregada');
